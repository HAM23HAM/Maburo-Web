					...
					<div class="row">
						<div class="col">
							<div class="header_content d-flex flex-row align-items-center justify-content-start">
								<div class="logo"><a href="index.php">Maburo</a></div>
								<nav class="main_nav">
									<ul>
										...
										<form action="" method="post">
													<input type="text" name="pencarian" size="30" placeholder="Cari sepatu" autocomplete="off">
									...
									<div class="col">
										<div class="home_slider_content" data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
											<div class="home_slider_title">
												<font size="5px">Toko Penjualan Sepatu Online</font> Maburo
											</div>
					...
					<div class="row">
						<div class="col">
							...
							<div class="product_grid">
								<?php
								$query = 
								"select * from produk b,produksi p
								where b.id_produksi = p.id_produksi";
								
								$result = mysqli_query($con, $query);

								if( isset($_POST["cari"]) ) {
									$keyword = $_POST["pencarian"];
									$result = mysqli_query($con, "SELECT * FROM produksi LEFT JOIN produk ON produksi.id_produksi = produk.id_produksi WHERE produk.nama_produk LIKE '%$keyword%' ");
								}
									...
									while($row = mysqli_fetch_assoc($result))
									{
										...
										<a href='product.php?id_produk=$id_produk'>
											...
											<div class='product_content'>
												<div class='product_title'>".$row['nama_produk']."</a></div>
												<div class='product_price'>Rp.".$row['harga'].",-</div>
												<br>
												<div class='nmproduksi'>".$row['nama_produksi']."</div>
											</div>
										</div>
										";
									}
