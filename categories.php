					...
					<div class="col">
						...
						<div class="product_grid">
							...
							<?php
								...
								where b.id_produksi = p.id_produksi AND b.id_kategori = '$kategori_terpilih'";
									...
									while($row = mysqli_fetch_assoc($result))
									{
										...
										<div class='product'>
											...
											<div class='product_content'>
												<div class='product_title'><a href='product.php?id_produk=$id_produk'>".$row['nama_produk']."</a></div>
