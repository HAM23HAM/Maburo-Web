...
else
{
    ...
    foreach ($_SESSION["keranjang"] as $id_produk => $jumlah) 
    {
        ...
        $query = $con->query("INSERT INTO transaksi (id_transaksi, id_customer, id_produk, tgl_transaksi, jumlah, total) VALUES ('T-$no', '$id_customer','$id_produk',now(), $jumlah, $subharga)");
